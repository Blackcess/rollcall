import { StudyArticleModel } from '../../Data Models/Subject Module Models/studyArticlesModel.js';
...
export const createArticle = async (req, res) => {
  try {
    ...
    const author_id = req.user?.id || req.body.author_id || null; // require auth ideally
...
export const getArticle = async (req, res) => {
  try {
    ...
    const article = await StudyArticleModel.findById(id);
